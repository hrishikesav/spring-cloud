...
@Component
public class ProductPantsDaoImpl implements ProductDao {
	
	List<Product> productPantsList = new ArrayList<Product>();
	...
	public List<Product> getProductByBrand(Product product) {
		...
		List<Product> resultProductList = productPantsList.stream()
